...
export default function Home() {
  return (
    <>
      <section className="min-h-full w-full pt-36 relative  flex items-center justify-center flex-col ">
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-20 mt-[-40px]">
        <h2 className="text-4xl text-center">Choose whats fits you right</h2>
        ...
        <div className="flex justify-center gap-4 flex-wrap mt-6">
          {pricingCards.map((card) => (
            // TODO: WIP FREE Product from stripe
